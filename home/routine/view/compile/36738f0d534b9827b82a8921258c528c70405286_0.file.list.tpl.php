<?php /* Smarty version 3.1.27, created on 2020-06-21 23:39:49
         compiled from "/usr/share/nginx/html/wolkbox.ulemus.com/home/routine/view/list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:21075239505ef04425310e36_04071840%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '36738f0d534b9827b82a8921258c528c70405286' => 
    array (
      0 => '/usr/share/nginx/html/wolkbox.ulemus.com/home/routine/view/list.tpl',
      1 => 1592804385,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21075239505ef04425310e36_04071840',
  'variables' => 
  array (
    'appName' => 0,
    'version' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5ef044253143d2_10100403',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5ef044253143d2_10100403')) {
function content_5ef044253143d2_10100403 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '21075239505ef04425310e36_04071840';
?>
<!DOCTYPE html>
<html lang="es" class="js">
    <head>
        ...
        <title class="has_page_title">Rutinas | <?php echo $_smarty_tpl->tpl_vars['appName']->value;?>
</title>
                                ...
                                <div class="container" id="container">
                                    ...
                                    <div class="breadcrumb-pageheader">
                                        <ol class="breadcrumb sm-breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Rutinas Creadas</li>
                                        </ol>
                                    </div>
                                    <!--END BREADCRUMB-->
                                    <!--BEGIN PAGE CONTENT-->
                                                                        ...
                                                                        <div class="sm-info">
                                                                            <div class="sm-info-with-icon">
                                                                                ...
                                                                                <div class="sm-info-text">
                                                                                    <h5 class="sm-inner-header">Rutinas </h5>
                                                                                    
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="table-responsive">
                                                                            <table id="dataTables-routines" class="table table-striped table-bordered">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th>ID Rutina</th>
                                                                                        <th>Nombre</th>
                                                                                        <th>Tipo</th>
                                                                                        <th>Dia Frecuencia</th>
                                                                                        <th>Hora Frecuencia</th>
                                                                                        <th>Minuto Frecuencia</th>
            ...
            <div class="modal-content">
                <div class="modal-body">
                     <fieldset class="form-horizontal">
                                ...
                                <input type="hidden" id="idRoutine"  name="idRoutine" class="form-control" placeholder="" readonly="true">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Nombre</label>
                                    <div class="col-md-12">
                                        <input type="text" id="nameRoutine" class="form-control" placeholder="" >
                                    </div>
                                </div>
                                <legend class ="hidden-frec">Frecuencia</legend>

                                <div class="form-group hidden-frec">
                                    <label class="col-md-4 control-label">Dia</label>
                                    <div class="col-md-12">
                                        <input type="number" min="0" id="day" name="day" class="form-control" placeholder="" >
                                    </div>
                                </div>
                                <div class="form-group hidden-frec">
                                    <label class="col-md-4 control-label">Hora</label>
                                    <div class="col-md-12">
                                        <input type="number" min="0" id="hour" name="hour" class="form-control" placeholder="" >
                                    </div>
                                </div>
                                <div class="form-group hidden-frec">
                                    <label class="col-md-4 control-label">Minuto</label>
                                    <div class="col-md-12">
                                        <input type="number" min="0" id="minute" name="minute" class="form-control" placeholder="">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <br>
                                    <button id="update-routine" class="btn btn-block btn-success" type="button">Actualizar</button>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                   
                                    <button id="delete-routine" class="btn btn-block btn-danger" type="button">Eliminar</button>
                                </div>
                            </div>
...
>
    <?php echo '<script'; ?>
 src="js/routinesList.js?<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"><?php echo '</script'; ?>
>
</body>
</html><?php }
