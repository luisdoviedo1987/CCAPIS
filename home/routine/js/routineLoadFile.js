...
var page = {
    Init : function () {
        global.options.url  = 'loadfile.php';
        $("#table-file").hide();
    ...
    sendRoutineFile : function(){
        ...
        response.then(function (data) {
            ...
            if(data.error){
                ...
                global.myToast(2, "Completado", 'La informacion fue cargada correctamente!', 'toast-top-right', 'toast-top-right');
