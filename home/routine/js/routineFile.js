                ...
                "columnDefs": [
                     {
                         ...
                         "render": function (data, type, row) {
                                ...
                                // "<label class='toggle-switch'><input type='checkbox' value='"+row.title+"' name='primary[]'  autocomplete='off'><span class='toggle-switch-slider round'></span></label>";
                         }
                     }
                 ]
            });
