<?php /* Smarty version 3.1.27, created on 2018-07-08 17:36:21
         compiled from "/usr/share/nginx/html/portal.medismart.net/user/home/view/home.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:17434098805b429ff52f8df1_16109878%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c3549580e8ec62b0d934267203bbc8a9147f4710' => 
    array (
      0 => '/usr/share/nginx/html/portal.medismart.net/user/home/view/home.tpl',
      1 => 1531092959,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17434098805b429ff52f8df1_16109878',
  'variables' => 
  array (
    'version' => 0,
    'menu' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5b429ff5301b54_52799893',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5b429ff5301b54_52799893')) {
function content_5b429ff5301b54_52799893 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '17434098805b429ff52f8df1_16109878';
?>
<!DOCTYPE html>
                                ...
                                <div class="container" id="container">
                                    ...
                                    <div class="breadcrumb-pageheader">
                                        <ol class="breadcrumb sm-breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Mi Carnet Virtual</li>
                                        </ol>
                                    </div>
                                    <!--END BREADCRUMB-->
                                    <!--BEGIN PAGE CONTENT-->
...
!
                                                                                ...
                                                                                <div class="sm-inner-desc text-justify m-b-8 m-l-3">
                                                                                    Como afiliado a MediSmart, usted podrá disfrutar de todas las coberturas en especialidades y servicios médicos presentando su carnet virtual de afiliado.
                                                                                </div>
                                                                                <button id="btn-my-card" name="btn-my-card" class="btn btn-success-medismart">Ver mí carnet virtual</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="modal-body p-0">
                        <div class="card" id="badge-content">
                            <div class="card-img-top view view-first" style="background-color: #789656;">
                                <div><button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-right:  8px;margin-top:  8px;">
                                    <span aria-hidden="true" style="color: #ddae00">X</span>
                                </button></div>
                                <br>
                                <div>
                                    <center>
                                    <div class="text-white fontbold" style="font-size: 26px;margin-left:  20px" >Carnet Virtual</div>
                                    <img id="qr-badge" src="QRLogo.php?data=1" alt="" height="90px" style="margin-top: 15px;margin-bottom: 25px">
                                    </center>
                                </div>
                            </div>
                            <div class="card-body">
                                <center>
                                <img id="medismart-logo-badge" src="../../resources/img/logo-medismart.png" class="" alt=""></center>
                            </div>
                            <div class="card-body" style="background-color: #003749;">
                                <div class="card-title text-white fontbold" id="name-badge" style="font-size: 18px">XXXXXXX XXXXXX XXXXXXX XXXXX</div>
                                <div class="card-text text-white fontlight" style="margin-top: -13px ;font-size: 12px" id="type-badge">Titular</div>
                                ...
                                <div class="card-text" style="margin-top: 10px " >
                                    ...
                                    <div class="card-text text-white fontlight" > www.medismart.net<br>
                                        ...
                                        <div id="btn-save-badge-div"> <button type="button" id="btn-save-badge" class="btn btn-wd btn-warning ladda-button m-t-10 text-white" data-style="zoom-in" data-spinner-color="#FFF" style="margin-top: -5px;" >
                                            <span class="ladda-label">Guardar</span>
                                            <span class="ladda-spinner"></span>
                                            <span class="ladda-spinner"></span><div class="ladda-progress" style="width: 140px;">
                                            
                                        </div>
                                    </button><br></div>
                                    <span  class="fontlight" style="margin-top: -5px;font-size: 12px" id="id-ios-banner" ></span>
