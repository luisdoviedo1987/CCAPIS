...
switch ($option) {
    case 1:
      ...
      case 3:
          ...
          $result = $accion->createRoutineFile($_SESSION["vIdUser"], "2", $form["routine_name"] , isset($form["primary"][0]) ? $form["primary"][0] : null  , $generated_table_name, $headerColumns , $dataColumns,  $sql_create_table) ;
