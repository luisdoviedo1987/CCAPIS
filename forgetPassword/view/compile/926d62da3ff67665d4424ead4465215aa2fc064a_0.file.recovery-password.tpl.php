<?php /* Smarty version 3.1.27, created on 2018-08-26 09:16:24
         compiled from "/usr/share/nginx/html/portal.medismart.net/forgetPassword/view/recovery-password.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:14169926065b82c448d4e6f3_37181099%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '926d62da3ff67665d4424ead4465215aa2fc064a' => 
    array (
      0 => '/usr/share/nginx/html/portal.medismart.net/forgetPassword/view/recovery-password.tpl',
      1 => 1535296575,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14169926065b82c448d4e6f3_37181099',
  'variables' => 
  array (
    'nombre_usuario' => 0,
    'id_usuario' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5b82c448d51631_14536893',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5b82c448d51631_14536893')) {
function content_5b82c448d51631_14536893 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '14169926065b82c448d4e6f3_37181099';
?>
<!DOCTYPE html>
<html lang="es" class="js">
    <head>
        ...
        <title class="has_page_title">Olvido Contraseña | Portal Medismart</title>
        <!-- BOOTSTRAP -->
                            ...
                            <div class="card form-card form-card--style-2 border-0 animated fadeInDown">
                                ...
                                <div class="form-body">
                                    <div class="text-center px-2">
                                        <h4 class="heading heading-4 strong-200 mb-0" style="margin-top:-10px">Hola <?php echo $_smarty_tpl->tpl_vars['nombre_usuario']->value;?>
</h4>
                                    </div>
                                    <br>
                                    Por favor ingresa una contraseña nueva <br>
                                    <form class="form-default mt-4" >
                                     <input type="hidden" id="id-user" name="id-user" value="<?php echo $_smarty_tpl->tpl_vars['id_usuario']->value;?>
">
                                     <input type="hidden" id="token-user" name="token-user" value="<?php echo $_smarty_tpl->tpl_vars['token_usuario']->value;?>
">
...
>
        <?php echo '<script'; ?>
 src="js/forget-password.js"><?php echo '</script'; ?>
>
    </body>
</html><?php }
}
