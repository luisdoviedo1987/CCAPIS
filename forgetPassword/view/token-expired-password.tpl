                        ...
                        <div class="col-lg-6">
                            <div class="card form-card form-card--style-2 border-0 animated fadeInDown">
                                ...
                                <div class="form-body">
                                     ...
                                     <br>
                                     Lo sentimos el link ya se encuentra vencido o no es valido, por favor solicita uno nuevamente.
                                     <br>
                                     <br>
                                    Saludos,
                                    ...
                                    <div class="m-t-20 f-s-12">
                                     <center> Olvidaste tu contraseña? Haz click <a href="./">aquí</a> para solicitar una nueva.</center>
                                 </div>
                                </div>
                            </div>
                        </div>
